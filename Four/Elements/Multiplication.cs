...
{
    class Multiplication : EquationElement
    {
        public EquationElement Element1;
        public EquationElement Element2;

        public Multiplication(EquationElement element1, EquationElement element2, int fours) : base(ElementTypes.Multiplication, fours)
        {
            Element1 = element1;
            Element2 = element2;
        }
